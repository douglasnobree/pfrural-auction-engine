...
export const floorBidBody = z.object({ participantId: z.string().min(1).max(200), amountCents: z.union([z.string().regex(/^\d+$/), z.number().int().positive()]), origin: z.enum(['FLOOR', 'PHONE']) });
